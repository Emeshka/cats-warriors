...
exports.s = {
	...
	about_tbook_pda_article:'Об этом курсе\nНедавно просмотрено: 71 979\nВ течение жизни мы постоянно'
		...
		+'вообще остаться без заветного студенческого билета. <endpage>Окончив вуз, юноши и девушки начинают искать '
		...
		+' последовательные, с совершенной и несовершенной<endpage> информацией, коалиционные и некоалиционные), '
		...
		+' складывается из результатов 10 оцениваемых тестов. Для успешного окончания курса необходимо дать не'
